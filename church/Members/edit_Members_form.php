<div class="row-fluid" style="background-color: #B9C1C6 ;">				  
                ...
                if (isset($_GET['id'])) {
                  ...
                  // Now you can safely use $get_member_id in your code.
                  // ...
              }
					...
					<div class="control-group">
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="pob" id="focusedInput" value="<?php echo $row['pob']; ?>" type="text" placeholder = "place of birth" > 
                                   </p>
                                 </div>
                                  </div>
								  </p>		
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="ministry" id="focusedInput" value="<?php echo $row['ministry']; ?>" type="text" placeholder = "ministry"> 
                                   </p>
                                 </div>
                                  </div>
								  </p>
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="mobile" id="focusedInput" value="<?php echo $row['mobile']; ?>" type="text" placeholder = "mobile number" required pattern="\d{10}" oninput="Limit(this, 10)" onkeydown="return isNumberKey(event);">
                                     <script>
                                      function Limit(input, maxLength) {
