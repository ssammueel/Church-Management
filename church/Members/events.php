            ...
            BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 7 DAY)");
                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i>Upcoming Events</div>
  ...
  <div class="row-fluid"> 
     <div class="empty">
	     <div class="pull-right">
		   <a href="#" class="btn btn-info" data-placement="left" title="Click to Print"><i ></i> --	--</a> 		      
		   <script type="text/javascript">
		     $(document).ready(function(){
		     $('#print').tooltip('show');
		     $('#print').tooltip('hide');
