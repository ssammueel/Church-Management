        ...
        <div class="container-fluid">
			<div class="navbar-header">
                ...
                <span class="icon-bar"></span>
                    ...
                    <span class="brand" href="#"><div class="pull-right"><i class="icon-time"></i><?php include('time.php'); ?></div></span>
			...
			<div class="nav-collapse collapse">
                <ul class="nav pull-right">
					...
					?>
                    <li class="dropdown">
                    <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"><img id="avatar1" class="img-responsive" src="<?php echo $row['thumbnail']; ?>">&nbsp;<?php echo $row['fname']." ".$row['lname'];  ?> <i class="caret"></i></a>
