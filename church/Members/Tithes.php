                 ...
                 ?>	 
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<form action="delete_tithes.php" method="post">
    <a data-placement="right" title="Click to Delete check item" data-toggle="modal" href="#tithes_delete" id="delete" class="btn btn-danger" name="">
