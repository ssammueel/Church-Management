...
<div class="muted pull-left"><i class="icon-plus-sign icon-large"> Register New teens</i></div>
</div>
<div class="block-content collapse in">
  ...
  <option value="Female">Female</option>
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="ministry" id="focusedInput" type="text" placeholder = "parent name" > 
                                   </p>
                                 </div>
                                  </div>
								  </p>	
...
if (isset($_POST['save'])) {
    ...
    $sname = $_POST['sname'];
    $lname = $_POST['lname'];
    $Gender = $_POST['gender']; // Fix: Change 'Gender' to 'gender'
    ...
    if ($count > 0) { ?>
        <script>
            alert('This teen already exists');
        </script>
    <?php } else {
