                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_kid.php" method="post">
									...
									<a data-placement="right" title="Click to Delete check item"  data-toggle="modal" href="#delete_kid" id="delete"  class="btn btn-danger" name=""><i class="icon-trash icon-large"> Delete</i></a>
