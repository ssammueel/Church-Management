        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span6" id="">
					...
					<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="membersDetail.php"><i></i> Full details</a></p>						
				<?php	
                 ...
                 ?>	 
                        <div id="block_bg" class="block">
							...
							<div class="span12">
							<form id="deleteForm" action="delete_ssl.php" method="post" onsubmit="return validateForm()">
							<a data-placement="right" title="Click to Delete checked item" 
                                    data-toggle="modal" href="#delete_member" id="delete"  
                                    class="btn btn-danger" name=""><i class="icon-trash icon-large"> Delete</i></a>		
